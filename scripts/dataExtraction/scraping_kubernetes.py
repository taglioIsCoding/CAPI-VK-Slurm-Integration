...
output_file = 'kubernetes-workers.csv' 
...
with open(output_file, mode='a', newline='') as csv_file:
    ...
    for host in bare_metal_hosts.get('items', []):
        ...
        machine_name = host['metadata']['ownerReferences'][0]['name']
        command = f"kubectl get secret {machine_name}-networkdata -n metal3 -o yaml | yq '.data.networkData' | base64 -d | yq '.networks.[0].ip_address'"
